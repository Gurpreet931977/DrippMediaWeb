    ...
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        :root {
            ...
            --deep-black: #050505;
            --pure-white: #ffffff;
            --card-w-horizontal: 500px;
            --card-h-horizontal: 281px;
            /* ~16:9 */
            --card-w-vertical: 281px;
            --card-h-vertical: 500px;
            /* ~9:16 */
        }
...
.nav-back:hover {
    ...
    color: #000 !important;
        ...
        .card-wrapper.card-horizontal {
            width: var(--card-w-horizontal);
            height: var(--card-h-horizontal);
        }

        .card-wrapper.card-vertical {
            width: var(--card-w-vertical);
            height: var(--card-h-vertical);
        }
        ...
        .face-bg {
            ...
            overflow: hidden;
            background: linear-gradient(165deg, rgba(20, 20, 20, 0.9) 0%, rgba(10, 10, 10, 0.95) 100%);
        ...
        .card-wrapper:hover .face-bg::before,
        .card-wrapper:hover .face-bg::after,
        .card-wrapper:hover .card-grid {
            opacity: 1;
        }
        ...
        .abstract-shape {
            ...
            background: repeating-linear-gradient(45deg,
                    transparent,
                    transparent 10px,
                    rgba(235, 215, 63, 0.05) 10px,
                    rgba(235, 215, 63, 0.05) 20px);
            border-radius: 50%;
            z-index: 0;
            pointer-events: none;
        ...
        .card-horizontal .abstract-shape {
            width: 150px;
            height: 150px;
            border-radius: 10px;
            right: 30px;
        ...
        /* Ambient Space Background Canvas */
        #space-canvas {
            position: fixed;
            top: 0;
            left: 0;
        ...
        @media (max-width: 900px) {
            * {
            ...
            .card-wrapper.card-vertical {
                width: 90vw;
                height: 400px;
                /* same height for both on mobile for consistency */
            }
