        ...
        <div className="contact-modal-sidebar">
          <div className="modal-header-block">
            <div className="modal-live-badge">
              ...
              <span>{isGenz ? 'direct line' : 'STRATEGY CALL'}</span>
            </div>
            <h3 className="modal-title">{isGenz ? "let's talk." : "Let's Talk."}</h3>
            <p className="modal-desc">
              {isGenz 
                ? "15-min direct audio call to map out creative vision, budget & execution." 
          ...
          <div className="contact-sidebar-guarantees" style={{ borderTop: 'none', paddingTop: 0 }}>
            <div className="sidebar-guarantee-item">
              ...
              <span>Phone or WhatsApp Audio</span>
            </div>
            <div className="sidebar-guarantee-item">
              <span className="guarantee-sparkle">•</span>
          ...
          <form className="modal-form" id="contact-form" style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            ...
            <div className="form-group">
              <div className="field-label-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                <label>{isGenz ? 'phone / whatsapp line' : 'Phone / WhatsApp Line'}</label>
            ...
            <div className="form-group">
              <label style={{ display: 'block', marginBottom: '6px' }}>{isGenz ? 'project scope' : 'Project Scope'}</label>
              <div className="scope-chip-cloud">
                {[
                  { id: 'web', label: isGenz ? 'web & apps' : 'Web & Apps' },
                  { id: 'video', label: isGenz ? 'video & reels' : 'Video & Reels' },
                  { id: 'cinema', label: isGenz ? 'shoots & cinema' : 'Cinema & Shoots' },
                  { id: 'graphics', label: isGenz ? 'branding & 3d' : 'Branding & 3D' },
                  { id: 'smm', label: isGenz ? 'social growth' : 'Social Growth' },
                  { id: 'retainer', label: isGenz ? 'full retainer' : 'Full Retainer' }
                ].map((option, idx) => (
                  <button
                    type="button"
                    key={option.id}
            ...
            <div className="form-group">
              <label style={{ display: 'block', marginBottom: '6px' }}>{isGenz ? 'when should we call?' : 'Preferred Call Time'}</label>
            ...
            <div className="form-group">
              <label style={{ display: 'block', marginBottom: '6px' }}>{isGenz ? 'brief / links (optional)' : 'Project Brief (Optional)'}</label>
            ...
            <button type="submit" className="modal-submit-capsule" id="contact-submit" style={{ marginTop: '4px' }}>
              ...
              <div className="modal-btn-label">
                ...
                <span className="modal-btn-text">{isGenz ? 'lock in strategy call' : 'Book Strategy Call'}</span>
              </div>
