  ...
  useEffect(() => {
    ...
    // --- INIT ---
        ...
        contactForm.addEventListener('submit', async (e) => {
            ...
            if (btnText) btnText.innerText = isGenz ? 'locking strategy call...' : 'Securing Strategy Call...';
            ...
            if (btnText) btnText.innerText = isGenz ? 'call locked ✓' : 'Call Confirmed ✓';
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    if (btnText) btnText.innerText = isGenz ? 'lock in strategy call' : 'Request Strategy Call & Scope Review';
                }, 600);
            }, 900);
        });
        ...
        communityForm.addEventListener('submit', async (e) => {
            ...
            if (btnText) btnText.innerText = isGenz ? 'securing spot...' : 'Securing Your Invite...';
            ...
            if (btnText) btnText.innerText = isGenz ? 'you are in ✓' : 'Invite Confirmed ✓';
            ...
            setTimeout(() => {
                closeCommunityModal();
                setTimeout(() => {
                    if (btnText) btnText.innerText = isGenz ? 'join the gang' : 'Request Access & Join';
  ...
  <section className="hero" id="home">
    ...
    <div className="hero-trust-bar">
      <div className="trust-item">
        ...
        <span className="trust-label">{isGenz ? 'organic views' : 'Organic Views'}</span>
      </div>
      <span className="trust-divider">✦</span>
      <div className="trust-item">
        <span className="trust-num">100+</span>
        <span className="trust-label">{isGenz ? 'brands scaled' : 'Brands Scaled'}</span>
      </div>
      <span className="trust-divider">✦</span>
      <div className="trust-item">
        <span className="trust-num">2-3 Wks</span>
        <span className="trust-label">{isGenz ? 'rapid delivery' : 'Rapid Delivery'}</span>
      </div>
      <span className="trust-divider">✦</span>
      <div className="trust-item">
        <span className="trust-num">Top 1%</span>
        <span className="trust-label">{isGenz ? 'design standard' : 'Design Standard'}</span>
      </div>
    </div>
  </section>
            ...
            <div className="back-content">
              ...
              <div style={{marginTop: 'auto', position: 'relative', zIndex: 10, transformStyle: 'preserve-3d'}}>
                <a href="/video-portfolio" className="card-launch-btn">
                  ...
                  <span className="card-btn-text">{isGenz ? 'enter cinema reel' : 'View Video Reel'}</span>
                </a>
              </div>
            </div>
          </div>
      ...
      <div className="card-wrapper locked" id="card2">
        <div className="card-inner">
          ...
          <div className="face face-back">
            ...
            <div className="back-content">
              <div className="back-header">
                <div className="back-title">{isGenz ? 'the vibe' : 'The Aesthetic'}</div>
              </div>
              <p className="back-text">{isGenz ? 'scalable design systems that work seamlessly from stories to billboards.' : 'Scalable design systems that work seamlessly from Instagram stories to billboards.'}</p>
              <div className="card-back-highlights">
              ...
              <div style={{marginTop: 'auto', position: 'relative', zIndex: 10, transformStyle: 'preserve-3d'}}>
                <a href="/graphic-portfolio" className="card-launch-btn">
                  ...
                  <span className="card-btn-text">{isGenz ? 'view design gallery' : 'View Design Gallery'}</span>
                </a>
              </div>
            </div>
          </div>
            ...
            <div className="back-content">
              ...
              <div style={{marginTop: 'auto', position: 'relative', zIndex: 10, transformStyle: 'preserve-3d'}}>
                <a href="/web-portfolio" className="card-launch-btn">
                  ...
                  <span className="card-btn-text">{isGenz ? 'explore web builds' : 'Explore Web Builds'}</span>
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="builder-left">
          ...
          <div className="builder-search-wrap">
            <div className="builder-search-box">
              ...
              <input 
                ...
                placeholder={isGenz ? "search 40+ creative drops (e.g. reels, 3d, web)..." : "Search 40+ creative services (e.g. 3D, reels, brand, web)..."}
                autoComplete="off"
                spellCheck="false"
              />
            ...
            <div className="chip-panels">
              ...
              <div className="chip-panel search-results-panel" id="search-results-panel" data-panel="search" style={{ display: 'none' }}>
                ...
                <div className="search-empty-state" id="search-empty-state" style={{ display: 'none' }}>
                  ...
                  <p className="search-empty-title">{isGenz ? 'no exact match found' : 'No matching service found'}</p>
                  <p className="search-empty-desc">{isGenz ? 'want custom chaos? write a bespoke scope below.' : 'Looking for custom deliverables? Submit your bespoke scope.'}</p>
                  <button 
                    type="button" 
          ...
          <div className="custom-service-creator">
            <div className="custom-service-creator-top">
              ...
              <span className="custom-service-creator-label">{isGenz ? 'need something off-menu?' : "Can't find your service?"}</span>
              <span className="custom-service-creator-hint">{isGenz ? 'type it here & add to loadout' : 'Write any custom service & add to cart'}</span>
            </div>
            <div className="custom-service-input-row">
              <div className="custom-service-input-wrap">
                <input 
                  ...
                  placeholder={isGenz ? "e.g. drone shoot, 3d billboard, custom drops..." : "e.g. Drone Cinematography, 3D Billboard, Multilingual Subtitles..."} 
                  maxLength={70}
                  autoComplete="off"
                  style={{ fontFamily: "'Clash Display', sans-serif" }}
                />
            ...
            >
              <span className="custom-service-creative-icon" aria-hidden="true">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="drip-mascot-svg">
                  <defs>
                    <linearGradient id="dripErrorGrad" x1="5" y1="2" x2="19" y2="23" gradientUnits="userSpaceOnUse">
                      <stop offset="0%" stopColor="#ff3366" />
                      <stop offset="100%" stopColor="#ff6b8b" />
                    </linearGradient>
                  </defs>
                  <path d="M12 2.5C12 2.5 5.5 10.5 5.5 15.5C5.5 19.366 8.41 22.5 12 22.5C15.59 22.5 18.5 19.366 18.5 15.5C18.5 10.5 12 2.5 12 2.5Z" fill="url(#dripErrorGrad)" />
          ...
          <div className="receipt-footer">
            <a href="#" className="custom-quote-btn" id="custom-quote-btn" onClick={(event) => window.dispatchEvent(new CustomEvent('inline-click', { detail: { action: `openContactModal(event, true)`, target: event.currentTarget, originalEvent: event } }))}>
              ...
              <div className="quote-btn-label">
                ...
                <span className="quote-btn-text">{isGenz ? 'request custom quote' : 'Request Custom Quote'}</span>
              </div>
            ...
            <a href="#" className="whatsapp-scope-btn" id="whatsapp-scope-btn" onClick={(e) => {
              ...
              <div className="wa-content-stack">
                <span className="wa-title">{isGenz ? 'chat on whatsapp' : 'Instant WhatsApp Scope'}</span>
                <span className="wa-sub-badge">
                  <span className="wa-sub-ping" />
                  {isGenz ? 'fast 1-on-1 · 5-min reply' : 'Fast 1-On-1 Connect · 5-Min Reply'}
                </span>
              </div>
      ...
      <div className="founder-text-block" id="founder-text-block">
        ...
        <div className="founder-badges-group">
          <div className="founder-badge-pill">
            ...
            <span className="founder-pill-text">{isGenz ? 'hands-on creative lead' : 'Hands-On Creative Director'}</span>
          </div>
          <div className="founder-badge-pill">
            <span className="founder-pill-icon">
            ...
            <span className="founder-pill-text">{isGenz ? 'direct founder line' : 'Direct Founder Line'}</span>
          </div>
          <div className="founder-badge-pill">
            <span className="founder-pill-icon">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round">
            ...
            <span className="founder-pill-text">{isGenz ? '100% standard' : '100% Quality Standard'}</span>
          </div>
        </div>
        <div>
          <a 
          ...
          >
            ...
            <div className="founder-btn-label">
              ...
              <span className="founder-btn-text">{isGenz ? 'talk to gurpreet on whatsapp' : 'Talk to Gurpreet on WhatsApp'}</span>
            </div>
  ...
  <section className="faq-section" id="faq">
    ...
    <div className="faq-container">
      <div className="faq-header">
        <span className="section-label">{isGenz ? '05 / the facts' : '05 / CLARITY & PROCESS'}</span>
        <h2 className="faq-title">{isGenz ? 'frequently asked ' : 'Frequently Asked '}<span>{isGenz ? 'questions.' : 'Questions.'}</span></h2>
        <p className="faq-sub">{isGenz ? 'everything you need to know about how we operate, drop projects, and communicate.' : 'Everything you need to know about our workflow, turnaround speed, revisions, and execution standards.'}</p>
      </div>
    ...
    <section className="join-community-section" id="community">
      ...
      <div className="community-wrapper">
        <div className="community-badge">
          ...
          <span>{isGenz ? '05 / the gang' : '05 / THE COLLECTIVE'}</span>
        </div>
        ...
        <div className="contact-modal-sidebar">
          <div className="modal-header-block">
            <div className="modal-live-badge">
              ...
              <span>{isGenz ? 'direct studio line · 24h drop' : 'DIRECT STUDIO INTAKE · STRATEGY CALL'}</span>
            </div>
            <h3 className="modal-title">{isGenz ? "let's build." : "Let's Talk."}</h3>
            <p className="modal-desc">{isGenz ? "drop your scope & lock in a direct call. we will call you at your decided time on your chosen line." : "Share your project scope and schedule a direct strategy call to map out creative direction, timeline, and execution."}</p>
          </div>
          ...
          <div className="strategy-value-card">
            <div className="strategy-value-item">
              ...
              <div className="strategy-value-text">
                <span className="strategy-value-title">{isGenz ? 'direct audio call' : 'Direct Audio Call'}</span>
                <span className="strategy-value-sub">{isGenz ? 'phone or whatsapp audio' : 'Direct Phone or WhatsApp Audio'}</span>
              </div>
            </div>
            ...
            <div className="strategy-value-item">
              ...
              <div className="strategy-value-text">
                <span className="strategy-value-title">{isGenz ? 'creative roadmap' : 'Creative & Scope Roadmap'}</span>
                <span className="strategy-value-sub">{isGenz ? 'budget, timeline & vibe' : 'Vision, budget & execution plan'}</span>
              </div>
            </div>
          </div>
          ...
          <div className="contact-sidebar-guarantees">
            <div className="sidebar-guarantee-item">
              ...
              <span>{isGenz ? 'we call you at your decided time' : 'Call on Your Decided Time & Line'}</span>
            </div>
            <div className="sidebar-guarantee-item">
              <span className="guarantee-sparkle">✦</span>
              <span>{isGenz ? 'senior creative lead' : 'Direct Senior Creative Lead'}</span>
            </div>
            <div className="sidebar-guarantee-item">
              <span className="guarantee-sparkle">✦</span>
              <span>{isGenz ? 'strict nda & zero spam' : 'Strict NDA & Zero Spam Guarantee'}</span>
            </div>
          </div>
        </div>
          ...
          <form className="modal-form" id="contact-form" style={{ display: 'flex' }}>
            ...
            <div className="form-group">
              <div className="field-label-row">
                <label>{isGenz ? 'project scope (multi-select)' : 'Project Scope'}</label>
                <span className="field-label-hint">{isGenz ? 'tap to choose multiple' : 'Select all that apply'}</span>
              </div>
              ...
              <div className="scope-dropdown-wrap" id="scope-dropdown-wrap">
                ...
                >
                  <div className="scope-trigger-text" id="scope-trigger-text">
                    {isGenz ? 'choose scopes...' : 'Select project scopes...'}
                  </div>
                ...
                <div className="scope-dropdown-menu" id="scope-dropdown-menu" role="listbox" data-lenis-prevent="true">
                  {[
                    ...
                    { id: 'web', label: isGenz ? 'web builds & framer' : 'Website Development' },
                    { id: 'app', label: isGenz ? 'mobile & web apps' : 'App Development' },
                    { id: 'smm', label: isGenz ? 'social growth & management' : 'Social Media Management' },
                    { id: 'graphics', label: isGenz ? 'branding & visuals' : 'Graphic Design & Identity' },
                    { id: '3d', label: isGenz ? '3d, cgi & vfx' : '3D Animation & VFX' },
                    { id: 'retainer', label: isGenz ? 'full studio retainer' : 'Full Creative Retainer' }
                  ].map((option) => (
                    <div
                      key={option.id}
                      ...
                      onClick={(e) => {
                        ...
                        if (selectedItems.length === 0) {
                          if (triggerText) {
                            triggerText.innerHTML = isGenz ? 'choose scopes...' : 'Select project scopes...';
            ...
            <div className="form-group">
              <div className="field-label-row">
                <label>{isGenz ? 'where should we call you?' : 'Call Channel Preference'}</label>
                <span className="field-label-hint">{isGenz ? 'audio call only' : 'Audio call only (no video)'}</span>
              </div>
              <div className="call-channel-grid">
                <button 
                  ...
                  onClick={(e) => {
                    ...
                    if (numLabel) numLabel.innerText = isGenz ? 'for direct phone call' : 'For direct phone call';
                  }}
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                  </svg>
                  <span>{isGenz ? 'direct phone call' : 'Direct Phone Call'}</span>
                  <span className="channel-badge">{isGenz ? 'primary' : 'Primary'}</span>
                </button>
                <button 
                  type="button" 
                  ...
                  onClick={(e) => {
                    ...
                    const numLabel = document.getElementById('contact-phone-hint');
                    if (numLabel) numLabel.innerText = isGenz ? 'for whatsapp audio call' : 'For WhatsApp audio call';
                  }}
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" />
                  </svg>
                  <span>{isGenz ? 'whatsapp call' : 'WhatsApp Call'}</span>
                </button>
              </div>
            </div>
            ...
            <div className="form-group">
              <div className="field-label-row">
                <label>{isGenz ? 'phone / whatsapp number' : 'Phone / WhatsApp Number'}</label>
                <span className="field-label-hint" id="contact-phone-hint">{isGenz ? 'for direct phone call' : 'For direct phone call'}</span>
              </div>
            ...
            <div className="form-group">
              <div className="field-label-row">
                <label>{isGenz ? 'when should we call?' : 'Preferred Call Time'}</label>
                <span className="field-label-hint">{isGenz ? 'we call you at this time' : 'We will call you at this time'}</span>
              </div>
            ...
            <div className="form-group">
              <div className="field-label-row">
                <label>{isGenz ? 'project brief / notes (optional)' : 'Project Scope / Brief (Optional)'}</label>
                <span className="field-label-hint">{isGenz ? 'drop any details' : 'Context for our strategy discussion'}</span>
              </div>
            ...
            <div className="contact-brief-footnote">
              ...
              <span>{isGenz ? 'we will call you at your decided time on your chosen line only. zero spam.' : 'We will call you directly at your selected time on your chosen line with zero spam.'}</span>
            </div>
            ...
            <button type="submit" className="modal-submit-capsule" id="contact-submit">
              ...
              <div className="modal-btn-label">
                ...
                <span className="modal-btn-text">{isGenz ? 'lock in strategy call' : 'Request Strategy Call & Scope Review'}</span>
              </div>
  ...
  <div className="modal-overlay" id="community-modal">
    <div className="modal-container contact-modal-box community-modal-box" data-lenis-prevent="true">
      ...
      <div className="modal-header-block">
        <div className="modal-live-badge">
          <span className="live-status-ping" />
          <span>{isGenz ? 'the private roster · invite only' : 'CREATOR NETWORK · PRIVATE ACCESS'}</span>
        </div>
        <h3 className="modal-title">{isGenz ? 'the collective.' : 'The Collective'}</h3>
        <p className="modal-desc">{isGenz ? 'join our private network of creators. no spam, just pure signal.' : 'Join our private network of creators, designers, and engineers. Zero spam, high-signal drops.'}</p>
      </div>
      ...
      <form className="modal-form" id="community-form">
        ...
        <div className="form-group">
          <div className="field-label-row">
            <label>{isGenz ? 'whatsapp line' : 'WhatsApp Number'}</label>
            <span className="field-label-hint">{isGenz ? 'for group invite' : 'For War Room invite'}</span>
          </div>
          <div className="community-input-wrap">
            <svg className="community-input-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
        ...
        <div className="form-group">
          <div className="field-label-row">
            <label>{isGenz ? 'your discipline' : 'Your Expertise'}</label>
            <span className="field-label-hint">{isGenz ? 'tap or type below' : 'Tap to select or type'}</span>
          </div>
          
          <div className="scope-chip-grid community-chips-grid">
            {[
              { id: 'video', label: isGenz ? 'video & motion' : 'Video Editing' },
              { id: 'web', label: isGenz ? 'web dev' : 'Web & Fullstack' },
              { id: 'graphics', label: isGenz ? 'brand identity' : 'Graphic & Branding' },
              { id: '3d', label: isGenz ? '3d & cgi' : '3D & Motion' },
              { id: 'director', label: isGenz ? 'creative lead' : 'Creative Director' },
              { id: 'content', label: isGenz ? 'script & copy' : 'Copy & Script' }
            ].map((chip) => (
              <button
                key={chip.id}
                type="button"
        ...
        <button type="submit" className="modal-submit-capsule" id="community-submit">
          ...
          <div className="modal-btn-label">
            <span className="modal-sparkle">✦</span>
            <span className="modal-btn-text">{isGenz ? 'join the gang' : 'Request Access & Join'}</span>
          </div>
          <div className="modal-action-disc">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.8" strokeLinecap="round" strokeLinejoin="round">
              <path d="M7 17L17 7M17 7H8M17 7V16" />
