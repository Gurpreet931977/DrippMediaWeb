        ...
        <div className="contact-modal-sidebar">
          ...
          <div className="modal-tabs contact-tabs-stacked">
            ...
            >
              ...
              <div className="tab-text-group">
                <span className="tab-title">{isGenz ? 'project brief' : 'Project Brief'}</span>
                <span className="tab-sub">{isGenz ? 'scope & details' : 'Scope, timeline & goals'}</span>
              </div>
            </button>
            <button 
              type="button"
            ...
            >
              ...
              <div className="tab-text-group">
                <span className="tab-title">{isGenz ? 'book 15-min call' : 'Book Strategy Call'}</span>
                <span className="tab-sub">{isGenz ? 'google meet' : '15-min video discovery'}</span>
              </div>
            </button>
          </div>
          ...
          <div className="contact-sidebar-guarantees">
            <div className="sidebar-guarantee-item">
              ...
              <span>{isGenz ? '24h initial response' : '24h Initial Response'}</span>
            </div>
            <div className="sidebar-guarantee-item">
              <span className="guarantee-sparkle">✦</span>
            ...
            <div className="sidebar-guarantee-item">
              <span className="guarantee-sparkle">✦</span>
              <span>{isGenz ? 'strict nda protected' : 'Strict NDA & Privacy Protected'}</span>
            </div>
          </div>
        </div>
        ...
        <div className="contact-modal-main">
          ...
          <form className="modal-form" id="contact-form-call" style={{ display: 'none' }} onSubmit={async (e) => {
            ...
            <button type="submit" className="modal-submit-capsule" id="call-submit">
              ...
              <div className="modal-btn-label">
                <span className="modal-sparkle">✦</span>
                <span className="modal-btn-text">{isGenz ? 'confirm call slot' : 'Confirm Strategy Call'}</span>
              </div>
              <div className="modal-action-disc">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.8" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M7 17L17 7M17 7H8M17 7V16" />
