...
const csp = [
  ...
  `img-src 'self' data: blob: https://*.supabase.co https://*.r2.cloudflarestorage.com https://*.r2.dev https://*.googleapis.com https://*.googletagmanager.com https://*.google-analytics.com https://*.analytics.google.com`,
  `connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.r2.cloudflarestorage.com https://*.r2.dev https://va.vercel-scripts.com https://vitals.vercel-insights.com https://*.googletagmanager.com https://*.google-analytics.com https://*.analytics.google.com blob:`,
  `media-src 'self' blob: https://*.r2.dev https://*.googleapis.com https://*.r2.cloudflarestorage.com`,
